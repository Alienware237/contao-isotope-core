...
use Contao\Database;
use Codefog\HasteBundle\Util\RepositoryVersion;
...
class Upgrade extends Controller
{
    ...
    public function run()
    {
        ...
        foreach (\Contao\Folder::scan(\Contao\System::getContainer()->getParameter('kernel.project_dir') . '/system/modules/isotope/library/Isotope/Upgrade') as $strFile) {
